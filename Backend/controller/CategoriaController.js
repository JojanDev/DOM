...
import CategoriaServicios from "../Services/Categoria.js";

class CategoriaController {
  static getAllCategorias = async (req, res) => {
    const objCategoria = new CategoriaServicios();
    const categorias = await objCategoria.getCategoriasProductos();
    res.json(categorias);
  };
  ...
  static getCategoriaByID = async (req, res) => {
    try {
      const { id } = req.params;
      const objCategoria = new CategoriaServicios();
      const categorias = await objCategoria.getCategoriaProductosByID(id);
